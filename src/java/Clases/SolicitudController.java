...
import Sesiones.SolicitudFacade;
...
public class SolicitudController implements Serializable {
    ...
    @EJB
    private Sesiones.SolicitudFacade ejbFacade;
    ...
    public Solicitud getSolicitud(java.lang.String id) {
