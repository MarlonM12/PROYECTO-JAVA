...
public class PaqueteController implements Serializable {
    ...
    @EJB
    private Sesiones.PaqueteFacade ejbFacade;
    ...
    public Paquete getPaquete(java.lang.String id) {
    ...
    public static class PaqueteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPaquete(getKey(value));
        }
